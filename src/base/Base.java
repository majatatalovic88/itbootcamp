...
public class Base {
	...
	public WebDriverWait waiter() {
	   ...
	   public void titleContain(String title) {
	   ...
	   public void textToBePresentInElement (By locator, java.lang.String text) {
	   ...
	   public <T> void refreshed(ExpectedCondition<T> condition){
